...
class OvinBase(AnimalBase):
    production_viande: bool = False
    production_reproduction: bool = False
    production_laine: bool = False
    qualite_laine: Optional[str] = None
...
class OvinUpdate(BaseModel):
    ...
    production_laine: Optional[bool] = None
    qualite_laine: Optional[str] = None
...
class OvinStats(AnimalVenteStats):
    total: int
    production_viande: int
    production_reproduction: int
    production_laine: int
